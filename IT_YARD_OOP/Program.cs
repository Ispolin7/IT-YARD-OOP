...
namespace IT_YARD
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var productRepository = new RepositoryGeneric<Product>();
            ...
            var repo = new JsonRepositoryGeneric<Address>();
            repo.Insert(firstAddress);
            repo.Insert(secondAddress);
            //var all = repo.All();
            //foreach(EntityBase item in all)
            //{
